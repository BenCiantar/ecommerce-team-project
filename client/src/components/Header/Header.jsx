...
const Header = (props) => {
  ...
  return (
    <header className="w-full h-24 bg-white border-b-2 border-black">
      <nav className="w-full h-full md:h-12 bg-white items-center flex flex-row justify-between ">
        ...
        <div className="cart-and-menu flex items-center lg:pr-4">
          ...
          <ul className="hidden menu-list lg:flex lg:flex-row text-base font-bold pr-3 ">
            ...
            <NavLink onClick={handleClick} to="/adventures" className="">
              <li className="menu-list-item px-3 ">Adventures</li>
            </NavLink>
            <NavLink onClick={handleClick} to="/culture" className="">
              <li className="menu-list-item px-3 ">Culture</li>
            </NavLink>
          </ul>
          <button className=" w-10 h-10 pr-3 " onClick={handleClickCart}>
      ...
      <section className="w-full h-8 mt-4 md:mt-0 md:justify-end md:pr-4 bg-white flex flex-row justify-center items-center">
